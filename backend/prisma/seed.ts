...
async function main() {
  ...
  const cmsSettings = [
    ...
    { key: "contact_address", value: "404 Crystalline Plaza, Tech Zone, Metro City, 10001" },
    { key: "contact_phone", value: "+91 98765 43210" },
    { key: "contact_whatsapp", value: "919876543210" },
    { key: "contact_email", value: "contact@hdtechsolutions.com" },
    { key: "business_hours", value: "Mon - Sat: 10:00 AM - 8:00 PM, Sunday: Closed" },
    { key: "google_maps_url", value: "https://maps.google.com/?q=404+Crystalline+Plaza,+Tech+Zone,+Metro+City,+10001" },
